...
const double baseline = 0.0056;
const double f = 880.0; // from horizontal fov = 0.6
...
public:
    ...
    int main(int argc, char** argv) {
        ...
        ros::NodeHandle n; // 
        ros::Publisher pub = n.advertise<cwru_msgs::VecOfDoubles>("blue_centroid", 1);        
        ImageConverter ic;
        cwru_msgs::VecOfDoubles centroid_coords_msg;
        centroid_coords_msg.dbl_vec.resize(3);
        ...
        while(ros::ok()) {
            ...
            centroid_coords_msg.dbl_vec[0]=x;
            centroid_coords_msg.dbl_vec[1]=y;
            centroid_coords_msg.dbl_vec[2]=z;
