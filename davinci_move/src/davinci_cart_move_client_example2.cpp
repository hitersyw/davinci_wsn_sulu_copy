...
int main(int argc, char** argv) {
    ...
    tf::StampedTransform tfResult_one,tfResult_two,tf_camera_to_left_optical;   
 ...
 //tf-listener found a complete chain from kinect pc frame to Torso;
    ...
    Eigen::Affine3d affine_camera_wrt_base_from_tf, affine_camera_wrt_left_optical;  
    ...
    p_wrt_lcamera = affine_lcamera_to_psm_two* p_wrt_world;
    ...
    p_wrt_lcamera[2] = p_wrt_lcamera[2] - 0.05;
     ROS_INFO("\n");
